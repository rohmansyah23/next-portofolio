...
const FORMSPREE_ENDPOINT = "https://formspree.io/f/xdaqpdrl";
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        fetch(FORMSPREE_ENDPOINT, {
            ...
            body: JSON.stringify({
                ...
                _subject: `${values.name} sent you a message from Portfolio`,
            }),
        }).then((res) => {
            if (res.ok) {
        ...
        <SectionWrapper id="contact" className="mt-16 md:mt-24 mx-4 lg:mx-0">
            ...
            <div className="w-full lg:w-5/6 2xl:w-3/4 mt-10 md:mt-16 mx-auto flex justify-between rounded-xl">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-gray-400 mb-4 text-sm md:text-base">My inbox is always open! Whether you&apos;ve got a question or want to say hello, feel free to reach out!</p>
