...
const Projects = ({ projectsData }: Props) => {
    ...
    return (
        <SectionWrapper id="projects" className="mx-4 md:mx-0 min-h-screen select-none">
