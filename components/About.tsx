                ...
                <div className="flex-1 text-left mx-4 mt-4 md:mt-0 md:mx-0 md:p-6">
                    <div className="flex flex-col gap-2.5">
                        ...
                        <div className="flex items-center gap-4 md:mt-4">
                            ...
                            {callUrl.trim() && <Link href={callUrl} target="_blank" className="text-violet-600 flex items-center gap-1 hover:bg-violet-50 hover:dark:bg-violet-900/10 py-2 px-4 transition-colors rounded-md">Let&apos;s Talk <FaWhatsapp /> </Link>}
                        </div>
                    </div>
                </div>
            </div>
